...
BUY_FAIL_COOLDOWN_SEC = int(os.getenv("BUY_FAIL_COOLDOWN_SEC", "3600"))  # 1h after any failed buy
BUY_GUARD_BLOCK_COOLDOWN_SEC = int(os.getenv("BUY_GUARD_BLOCK_COOLDOWN_SEC", "86400"))  # 24h on guard block
BUY_FAIL_ALERT_INTERVAL_SEC = int(os.getenv("BUY_FAIL_ALERT_INTERVAL_SEC", "1800"))  # max 1 tg alert / 30m / mint
